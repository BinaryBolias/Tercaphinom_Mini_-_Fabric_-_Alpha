package binarybolias.tercaphinom.mixin.screen;
...
/**
 * Note: This mixin produces a conflict with a more fundamental force I cannot comprehend;
 * there seems to be an injections targeting the <code>updateResult</code> method
 * which conflicts with my intense desire to overwrite it.
 * <br><br>
 * I'll just use a custom class instead.
 */
@Mixin(AnvilScreenHandler.class)
public abstract class AnvilScreenHandlerMixin extends ForgingScreenHandler {
	@Unique private static final int TARGET_INPUT_ID = 0;
	@Unique private static final int MATERIAL_INPUT_ID = 1;
	@Unique private static final int OUTPUT_ID = 2;
	
	@Unique private static final int SLOT_Y_POS = 47;
	
	@Shadow private int repairItemUsage;
	@Shadow private @Nullable String newItemName;
	@Shadow @Final private Property levelCost;
	
	//TODO: Use a custom class instead of this mixin.
	// - Figure out where this class is created/referenced (probably in the anvil block class).
	// - Use a mixin at the proper location to reference the new class (deriving from the code here) instead.
	
	
	/**
	 * Seemingly superfluous constructor for compiler reassurance.
	 */
	...
	/**
	 * @author BinaryBolias
	 * @reason Because I feel like it.<br>
	 * Although... the positions of these slots may be changed in-future...
	 */
	@Overwrite
	...
	/**
	 * @author BinaryBolias
	 * @reason Modifying the anvil damage chance to be based on the anvil operation level cost.<br>
	...
	/**
	 * @author BinaryBolias
	 * @reason General refactoring.<br>
	 * Removing logic for repair cost item components,

...
//			.alwaysEdible()
//			.build();
	public static final FoodComponent ENCHANTED_GOLDEN_APPLE = foodComponentBuilder(4, 1.25F)
			.statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 400, 1), 1.0F)
			.statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 6000, 0), 1.0F)
			.statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 6000, 0), 1.0F)
			.statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 3), 1.0F)
...
//			.alwaysEdible()
//			.build();
	public static final FoodComponent GLISTERING_MELON_SLICE = foodComponentBuilder(2, 0.5F)
			.statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 200, 0), 1.0F)
			.build();
	public static final FoodComponent GOLDEN_APPLE = foodComponentBuilder(4, 1.25F)
			.statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 100, 1), 1.0F)
			.statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 2400, 0), 1.0F)
			.build();
//	public static final FoodComponent GOLDEN_CARROT = new FoodComponent.Builder().nutrition(6).saturationModifier(1.2F).build();
	public static final FoodComponent GOLDEN_CARROT = foodComponentBuilder(6, 1.25F).build();
	
	//# Meat (cooked) #
//	public static final FoodComponent COOKED_BEEF = new FoodComponent.Builder().nutrition(8).saturationModifier(0.8F).build();
	public static final FoodComponent COOKED_BEEF_STEAK = foodComponentBuilder(8, 0.75F).build();
...
//	public static final FoodComponent COOKED_CHICKEN = new FoodComponent.Builder().nutrition(6).saturationModifier(0.6F).build();
	public static final FoodComponent COOKED_CHICKEN = foodComponentBuilder(6, 0.5F).build();
//	public static final FoodComponent COOKED_COD = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
	public static final FoodComponent COOKED_COD = foodComponentBuilder(5, 0.5F).build();
...
//	public static final FoodComponent COOKED_MUTTON = new FoodComponent.Builder().nutrition(6).saturationModifier(0.8F).build();
	public static final FoodComponent COOKED_MUTTON_STEAK = foodComponentBuilder(6, 0.75F).build();
//	public static final FoodComponent COOKED_PORKCHOP = new FoodComponent.Builder().nutrition(8).saturationModifier(0.8F).build();
	public static final FoodComponent COOKED_PORKCHOP = foodComponentBuilder(8, 0.75F).build();
//	public static final FoodComponent COOKED_RABBIT = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
	public static final FoodComponent COOKED_RABBIT = foodComponentBuilder(5, 0.5F).build();
//	public static final FoodComponent COOKED_SALMON = new FoodComponent.Builder().nutrition(6).saturationModifier(0.8F).build();
	public static final FoodComponent COOKED_SALMON = foodComponentBuilder(6, 0.5F).build();
	
	//# Meat (raw) #
//	public static final FoodComponent BEEF = new FoodComponent.Builder().nutrition(3).saturationModifier(0.3F).build();
	public static final FoodComponent RAW_BEEF_STEAK = foodComponentBuilder(3, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 200, 0), 0.3125F)
			.build();
	public static final FoodComponent RAW_BUGMEAT_STEAK = foodComponentBuilder(3, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 300, 0), 1.0F)
			.statusEffect(statusEffectInstance(StatusEffects.POISON, 100, 0), 1.0F)
			.build();
...
//			.build();
	public static final FoodComponent RAW_CHICKEN = foodComponentBuilder(2, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 600, 0), 0.3125F)
			.build();
//	public static final FoodComponent COD = new FoodComponent.Builder().nutrition(2).saturationModifier(0.1F).build();
	public static final FoodComponent RAW_COD = foodComponentBuilder(2, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 120, 0), 0.25F)
			.build();
	public static final FoodComponent RAW_MEAT_MORSEL = foodComponentBuilder(2, 0.125F).snack()
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 120, 0), 0.25F)
			.build();
//	public static final FoodComponent MUTTON = new FoodComponent.Builder().nutrition(2).saturationModifier(0.3F).build();
	public static final FoodComponent RAW_MUTTON_STEAK = foodComponentBuilder(2, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 200, 0), 0.3125F)
			.build();
//	public static final FoodComponent PORKCHOP = new FoodComponent.Builder().nutrition(3).saturationModifier(0.3F).build();
	public static final FoodComponent RAW_PORKCHOP = foodComponentBuilder(3, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 200, 0), 0.3125F)
			.build();
...
//			.build();
	public static final FoodComponent RAW_PUFFERFISH = foodComponentBuilder(1, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 600, 0), 1.0F)
			.statusEffect(statusEffectInstance(StatusEffects.POISON, 900, 0), 1.0F)
			.statusEffect(statusEffectInstance(StatusEffects.NAUSEA, 300, 0), 1.0F)
			.build();
//	public static final FoodComponent RABBIT = new FoodComponent.Builder().nutrition(3).saturationModifier(0.3F).build();
	public static final FoodComponent RAW_RABBIT = foodComponentBuilder(3, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 200, 0), 0.3125F)
			.build();
//	public static final FoodComponent SALMON = new FoodComponent.Builder().nutrition(2).saturationModifier(0.1F).build();
	public static final FoodComponent RAW_SALMON = foodComponentBuilder(2, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 120, 0), 0.25F)
			.build();
//	public static final FoodComponent TROPICAL_FISH = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1F).build();
	public static final FoodComponent RAW_TROPICAL_FISH = foodComponentBuilder(1, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 120, 0), 0.25F)
			.build();
	
	//# Vegetable (baked) #
	public static final FoodComponent BAKED_CARROT = foodComponentBuilder(4, 0.6F).build();
	public static final FoodComponent BAKED_MUSHROOM = foodComponentBuilder(2, 0.5F).build();
//	public static final FoodComponent BAKED_POTATO = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
	public static final FoodComponent BAKED_POTATO = foodComponentBuilder(5, 0.5F).build();
	public static final FoodComponent BAKED_RADISH = foodComponentBuilder(4, 0.75F).build();
...
//			.build();
	public static final FoodComponent POISONOUS_POTATO = foodComponentBuilder(2, 0.5F)
			.statusEffect(new StatusEffectInstance(StatusEffects.POISON, 100, 0), 0.5625F)
			.build();
//	public static final FoodComponent CARROT = new FoodComponent.Builder().nutrition(3).saturationModifier(0.6F).build();
	public static final FoodComponent RAW_CARROT = foodComponentBuilder(3, 0.5F).build();
//	public static final FoodComponent POTATO = new FoodComponent.Builder().nutrition(1).saturationModifier(0.3F).build();
	public static final FoodComponent RAW_POTATO = foodComponentBuilder(1, 0.5F).build();
//	public static final FoodComponent BEETROOT = new FoodComponent.Builder().nutrition(1).saturationModifier(0.6F).build();
	public static final FoodComponent RAW_RADISH = foodComponentBuilder(1, 0.5F).build();
	
	//# Miscellaneous #
	public static final FoodComponent CHEESE_WHEEL = foodComponentBuilder(5, 0.6F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 300, 0), 1.0F)
			.build();
...
//	public static final FoodComponent DRIED_KELP = new FoodComponent.Builder().nutrition(1).saturationModifier(0.3F).snack().build();
	public static final FoodComponent DRY_KELP_LEAF = foodComponentBuilder(1, 0.25F).snack().build();
	public static final FoodComponent FERMENTED_SPIDER_EYE = foodComponentBuilder(3, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 400, 0), 0.75F)
			.statusEffect(statusEffectInstance(StatusEffects.NIGHT_VISION, 300, 0), 0.75F)
			.statusEffect(statusEffectInstance(StatusEffects.POISON, 160, 0), 1.0F)
			.statusEffect(statusEffectInstance(StatusEffects.SLOWNESS, 300, 0), 0.75F)
			.statusEffect(statusEffectInstance(StatusEffects.WEAKNESS, 300, 0), 0.75F)
			.build();
	...
	public static final FoodComponent LIVE_GRASS_TUFT = foodComponentBuilder(1, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 120, 0), 1.0F)
			.build();
	public static final FoodComponent NETHERWART_PILE = foodComponentBuilder(2, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 300, 1), 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 300, 0), 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.SLOWNESS, 300, 0), 0.5F)
			.build();
...
//			.build();
	public static final FoodComponent ROTTEN_FLESH_CHUNK = foodComponentBuilder(3, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 900, 0), 0.78125F)
			.build();
...
//			.build();
	public static final FoodComponent SPIDER_EYE = foodComponentBuilder(2, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.POISON, 100, 0), 1.0F)
			.build();
	public static final FoodComponent WARPED_FLESH_CHUNK = foodComponentBuilder(4, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 900, 0), 0.78125F)
			.build();
	//endregion
...
//	public static final FoodComponent COOKIE = new FoodComponent.Builder().nutrition(2).saturationModifier(0.1F).build();
	public static final FoodComponent COOKIE = foodComponentBuilder(2, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.SPEED, 200, 0), 1.0F)
			.build();
	...
	public static final FoodComponent RAW_COOKIE_BALL = foodComponentBuilder(1, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 80, 0), 0.75F)
			.build();
...
//	public static final FoodComponent PUMPKIN_PIE = new FoodComponent.Builder().nutrition(8).saturationModifier(0.3F).build();
	...
	public static final FoodComponent RAW_APPLE_PIE = foodComponentBuilder(12, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 160, 0), 1.0F)
			.statusEffect(statusEffectInstance(StatusEffects.SLOWNESS, 100, 0), 1.0F)
			.build();
...
//	public static final FoodComponent BREAD = new FoodComponent.Builder().nutrition(5).saturationModifier(0.6F).build();
	public static final FoodComponent BREAD_LOAF = foodComponentBuilder(6, 0.5F).build();
	//# Miscellaneous - Raw #
	public static final FoodComponent RAW_CAKE = foodComponentBuilder(6, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 160, 0), 1.0F)
			.build();
	public static final FoodComponent RAW_DOUGH_LUMP = foodComponentBuilder(3, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 160, 0), 1.0F)
			.build();
	//endregion
...
//	public static final FoodComponent HONEY_BOTTLE = new FoodComponent.Builder().nutrition(6).saturationModifier(0.1F).build();
	public static final FoodComponent BOTTLE_OF_HONEY = foodComponentBuilder(6, 0.125F)
...
//	public static final FoodComponent BEETROOT_SOUP = new FoodComponent.Builder().nutrition(6).saturationModifier(0.6F).build();
	public static final FoodComponent BOWL_OF_RADISH_SOUP = foodComponentBuilder(14, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 250, 0), 1.0F)
			.build();
	
	//# Stew #
	public static final FoodComponent BOWL_OF_BEEF_STEW = stewBuilder(COOKED_BEEF_STEAK, 2, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_BUGMEAT_STEW = stewBuilder(COOKED_BUGMEAT_STEAK, 2, 0.375F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_CHICKEN_STEW = stewBuilder(COOKED_CHICKEN, 2, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_COD_STEW = stewBuilder(COOKED_COD, 2, 0.375F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_MORSEL_STEW = stewBuilder(COOKED_MEAT_MORSEL, 1, 0.25F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 400, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_MUTTON_STEW = stewBuilder(COOKED_MUTTON_STEAK, 2, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_PORK_STEW = stewBuilder(COOKED_PORKCHOP, 2, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_RABBIT_STEW = stewBuilder(COOKED_RABBIT, 2, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_SALMON_STEW = stewBuilder(COOKED_SALMON, 2, 0.375F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 500, 0), 1.0F)
			.build();
...
//	public static final FoodComponent SUSPICIOUS_STEW = new FoodComponent.Builder().nutrition(6).saturationModifier(0.6F).build();
	public static final FoodComponent BOWL_OF_SUSPICIOUS_STEW = foodComponentBuilder(6, 0.5F)
			.build();
	...
	public static final FoodComponent BOWL_OF_STEAMING_WATER = foodComponentBuilder(1, 0.125F)
			...
			.statusEffect(statusEffectInstance(StatusEffects.SPEED, 480, 0), 1.0F)
			.build();
	public static final FoodComponent BOWL_OF_WATER = foodComponentBuilder(0, 0.0F)
	...
	public static final FoodComponent BUCKET_OF_HONEY = foodComponentBuilder(18, 0.125F)
			.statusEffect(statusEffectInstance(StatusEffects.REGENERATION, 400, 0), 1.0F)
			.statusEffect(statusEffectInstance(StatusEffects.SLOWNESS, 200, 0), 1.0F)
			.build();
	...
	//# Miscellaneous #
	public static final FoodComponent CANDESAND_PILE = foodComponentBuilder(2, 0.5F)
			.statusEffect(statusEffectInstance(StatusEffects.HUNGER, 300, 1), 1.0F)
			.statusEffect(statusEffectInstance(StatusEffects.SPEED, 400, 1), 1.0F)
			.build();
	...
	public static final FoodComponent MINIWIZARD = foodComponentBuilder(2, 1.5F)
			...
			.statusEffect(statusEffectInstance(StatusEffects.WATER_BREATHING, 240, 0), 1.0F)
			.alwaysEdible().build();
	public static final FoodComponent STARCHCAP_MUSHROOM = foodComponentBuilder(1, 0.125F).build();
	//endregion
	...
	private static FoodComponent.Builder stewBuilder(FoodComponent baseFood, int bonusNutrition, float saturationModifier) {
		...
		int bakedPotatoNutrition = BAKED_POTATO.nutrition();
		
		int baseNutrition = baseFood.nutrition() + bakedCarrotNutrition + bakedMushroomNutrition + bakedPotatoNutrition;
		
		return new FoodComponent.Builder().nutrition(baseNutrition + bonusNutrition).saturationModifier(saturationModifier);
	}
	//endregion

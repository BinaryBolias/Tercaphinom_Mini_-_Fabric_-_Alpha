...
public class ModBlocks {
	...
	public static final Block VERDAK_PLANK_BLOCK = registerBlockWithItem("verdak_plank_block",
			new Block(FabricBlockSettings.copyOf(Blocks.OAK_PLANKS))); // TODO: Make unique.
	
	//# Stone (brick) #
	public static final Block STIEFANE_BRICK_BLOCK = registerBlockWithItem("stiefane_brick_block",
			new Block(FabricBlockSettings.copyOf(Blocks.STONE_BRICKS))); // TODO: Make unique.
	
	//# Stone (cobbled) #
	public static final Block COBBLED_STIEFANE_BLOCK = registerBlockWithItem("cobbled_stiefane_block",
			new Block(FabricBlockSettings.copyOf(Blocks.COBBLESTONE))); // TODO: Make unique.
	
	//# Stone (natural) #
	public static final Block STIEFANE_BLOCK = registerBlockWithItem("stiefane_block",
			new Block(FabricBlockSettings.copyOf(Blocks.STONE))); // TODO: Make unique.
	
	//# Stone (polished) #
	public static final Block POLISHED_STIEFANE_BLOCK = registerBlockWithItem("polished_stiefane_block",
			new Block(FabricBlockSettings.copyOf(Blocks.SMOOTH_STONE))); // TODO: Make unique.
	...
	public static final Block STIEFANE_LAPIS_ORE = registerBlockWithItem("stiefane_lapis_ore",
			new Block(FabricBlockSettings.copyOf(Blocks.LAPIS_ORE))); // TODO: Make unique.
	...
	public static final Block STIEFANE_BUTTON = registerBlockWithItem("stiefane_button",
			new ButtonBlock(BlockSetType.STONE, 30, FabricBlockSettings.copyOf(Blocks.STONE_BUTTON))); // TODO: Make unique.
	public static final Block STIEFANE_PRESSURE_PLATE = registerBlockWithItem("stiefane_pressure_plate",
			new PressurePlateBlock(BlockSetType.STONE, FabricBlockSettings.copyOf(Blocks.STONE_PRESSURE_PLATE))); // TODO: Make unique.
	public static final Block VERDAK_BUTTON = registerBlockWithItem("verdak_button",
			new ButtonBlock(BlockSetType.OAK, 30, FabricBlockSettings.copyOf(Blocks.OAK_BUTTON))); // TODO: Make unique.
	public static final Block VERDAK_PRESSURE_PLATE = registerBlockWithItem("verdak_pressure_plate",
			new PressurePlateBlock(BlockSetType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_PRESSURE_PLATE))); // TODO: Make unique.
	
	//# Container & Workstation #
	
	//# Door & Hatch #
	public static final Block VERDAK_DOOR = registerBlockWithItem("verdak_door",
			new DoorBlock(BlockSetType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_DOOR))); // TODO: Make unique.
	public static final Block VERDAK_HATCH = registerBlockWithItem("verdak_hatch",
			new TrapdoorBlock(BlockSetType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR))); // TODO: Make unique.
	...
	public static final Block STIEFANE_BRICK_WALL_POST = registerBlockWithItem("stiefane_brick_wall_post",
			new WallBlock(FabricBlockSettings.copyOf(Blocks.STONE_BRICK_WALL))); // TODO: Make unique.
	public static final Block VERDAK_FENCE_GATE = registerBlockWithItem("verdak_fence_gate",
			new FenceGateBlock(WoodType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_FENCE_GATE))); // TODO: Make unique.
	public static final Block VERDAK_FENCE_POST = registerBlockWithItem("verdak_fence_post",
			new FenceBlock(FabricBlockSettings.copyOf(Blocks.OAK_FENCE))); // TODO: Make unique.
	...
	public static final Block STIEFANE_BRICK_SLAB = registerBlockWithItem("stiefane_brick_slab",
			new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_BRICK_SLAB))); // TODO: Make unique.
	public static final Block STIEFANE_BRICK_STAIR = registerBlockWithItem("stiefane_brick_stair",
			new StairsBlock(STIEFANE_BRICK_BLOCK.getDefaultState(), FabricBlockSettings.copyOf(Blocks.STONE_BRICK_STAIRS))); // TODO: Make unique.
	public static final Block VERDAK_PLANK_SLAB = registerBlockWithItem("verdak_plank_slab",
			new SlabBlock(FabricBlockSettings.copyOf(Blocks.OAK_PLANKS))); // TODO: Make unique.
	public static final Block VERDAK_PLANK_STAIR = registerBlockWithItem("verdak_plank_stair",
			new StairsBlock(VERDAK_PLANK_BLOCK.getDefaultState(), FabricBlockSettings.copyOf(Blocks.OAK_PLANKS))); // TODO: Make unique.
	...
	public static final Block ETERNALITH = registerBlockWithItem("eternalith", // Rename to "eternalith_block"?
			new Block(FabricBlockSettings.copyOf(Blocks.BEDROCK))); // TODO: Make unique.
	//endregion
	
	//region  ## Joke & Unserious ##
	//# Miscellaneous #
	public static final Block ULTRASMOOTH_STONE = registerBlockWithItem("ultrasmooth_stone",
			new Block(FabricBlockSettings.copyOf(Blocks.SMOOTH_STONE).slipperiness(0.98F))); // Same slipperiness as ice, packed ice, and frosted ice.

...
public class BucketStatusEffectCureBeverageItem extends BucketBeverageItem {
	private final ArrayList<RegistryEntry<StatusEffect>> curedStatusEffects;
	
	public BucketStatusEffectCureBeverageItem(ArrayList<RegistryEntry<StatusEffect>> curedStatusEffects, Settings settings) {
		super(settings);

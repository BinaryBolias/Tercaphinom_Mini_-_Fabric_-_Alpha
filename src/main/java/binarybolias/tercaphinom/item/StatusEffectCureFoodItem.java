...
public class StatusEffectCureFoodItem extends Item {
	private final ArrayList<RegistryEntry<StatusEffect>> curedStatusEffects;
	
	public StatusEffectCureFoodItem(ArrayList<RegistryEntry<StatusEffect>> curedStatusEffects, Settings settings) {
		super(settings);

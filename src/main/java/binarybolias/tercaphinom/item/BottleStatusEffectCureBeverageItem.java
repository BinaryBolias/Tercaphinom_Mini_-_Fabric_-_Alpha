...
public class BottleStatusEffectCureBeverageItem extends BottleBeverageItem{
	private final ArrayList<RegistryEntry<StatusEffect>> curedStatusEffects;
	
	public BottleStatusEffectCureBeverageItem(ArrayList<RegistryEntry<StatusEffect>> curedStatusEffects, Settings settings) {
		super(settings);
